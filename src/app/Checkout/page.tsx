        ...
        <div className="w-full md:w-1/2 px-6 py-10 ">
         ...
         <div className="flex justify-between border-b-2 border-[#9F9F9F]">
            ...
            <div className="flex items-center gap-2 text-xl mt-4">
                <span className="text-4xl"><GoDotFill /></span> Direct Bank Transfer
                 </div>
                 <p className="text-[#9F9F9F] my-4">Make your payment directly into our bank account. Please use your Order ID as the payment reference. Your order will not be shipped until the funds have cleared in our account.</p>
            ...
            <p className="my-4" >Your personal data will be used to support your experience throughout this website, to manage access to your account, and for other purposes described in our <span className="font-semibold">privacy policy.</span></p>
